...
export function NewsCard({ item, onClick }: NewsCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[calc(100%/2)] right-8 z-30 -translate-y-1/2">
      ...
      <div className="relative z-10 p-6 pt-10 flex flex-col flex-1">
        ...
        <h3 className="text-base font-bold text-[#0a1a1f] dark:text-white transition-colors group-hover:text-teal-500 lg:text-lg line-clamp-2 flex-1 leading-snug">
          {item.title}
        </h3>
