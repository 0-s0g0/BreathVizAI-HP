        ...
        items: [
         {
            ...
            "detail": "NEDOの「研究開発型スタートアップの起業・経営人材確保等支援事業（NEP）」の一環として実施する、九州地域における女性のディープテック（研究開発型）起業支援プログラム「新星コース」に新星起業家候補生として採択されました。今後の開発資金として活用し、一年間社会実装を見据えて実装に向け取り組みます。",
